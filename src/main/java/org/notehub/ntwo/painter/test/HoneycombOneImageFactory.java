...
public class HoneycombOneImageFactory extends AbstractImageFactory
implements ImageFactory{
	...
	*/
	...
	public void paint(Graphics2D g2){
		...
		HoneycombOne hone=new HoneycombOne();
		//hone.setCellRate(3.1f);
		//hone.setDistRate(1.1f);
		
		hone.setLocation(new XPoint());
		hone.setSize(new XDimension(size.width,size.height));
		
		HexagonShape[] list=hone.getHexagonShapes();
